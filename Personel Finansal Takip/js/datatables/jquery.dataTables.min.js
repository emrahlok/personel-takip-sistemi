...
"_" + location.pathname, JSON.stringify(b))
    ...
    oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "Ilk", sLast: "Son", sNext: "Sonraki", sPrevious: "Onceki" }, sEmptyTable: "Gosterilecek kayit yok.", sInfo: "Toplam _TOTAL_ kayittan _START_ - _END_ arasi gosteriliyor.", sInfoEmpty: "Toplam 0 kayittan 0 - 0 arasi gosteriliyor.",
sInfoFiltered:"(_MAX_ kayittan filtrelenen)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Sayfa basina _MENU_ kayit goster.",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Kayitlarda Ara:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Eslesen kayit bulunamadi."},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
