...
namespace Personel_Finansal_Takip.Areas.employee.Models
{
    public class IzinViewModel
    {
        public IzinStateView izinState { get; set; }
        public List<izinler> pIzinler { get; set; }
    }

    public class IzinStateView
    {
        ...
        public IzinStateView(string usermail)
        {
            var personel = db.personels.Where(x => x.e_posta.Equals(usermail)).FirstOrDefault();
